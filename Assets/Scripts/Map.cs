...
public class Map : MonoBehaviour
{
    ...
    private const int maze_size = 7, fill_size = 13;
                ...
                if (fill_grid[x, y] != 1)
                    map_contents.Add(
                        Instantiate(Random.Range(0, 5) == 0 ?
                            ...
                            new Vector3(x, y, 2), Quaternion.identity)
                        );
    }

    private void Generate_maze(int prev_x, int prev_y, int x, int y)
    {
        ...
        while (directions.Count > 0)
        {
            ...
            {
                case 0:
                    Generate_maze(x, y, x + 1, y);
                    break;
                case 1:
                    Generate_maze(x, y, x - 1, y);
                    break;
                case 2:
                    Generate_maze(x, y, x, y + 1);
                    break;
                case 3:
                    Generate_maze(x, y, x, y - 1);
                    break;
